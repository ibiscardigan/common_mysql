...
class connection:
    def __init__(self, config: configparser.ConfigParser) -> None:  # pragma: no cover
    ...
    def connect(self, database_name: str = None) -> None:  # pragma: no cover
    ...
    def standard_query(self, statement: str, query_params: list = []) -> list:
        ''''''
    ...
    def standard_execute(self, statement: str, query_params: list = []) -> int:
